...
def train(args, snapshot_path):
    ...
    #2Create EMA Network to avoid Back Propagation
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            # # Add this loop to print each datapoint in the batch
            ...
            #     # Plot label
            #     plt.imshow(label, cmap='gray')  # assuming label is in (H, W) format
            #     plt.title('Label')
            #     plt.show()
            #Change begins
